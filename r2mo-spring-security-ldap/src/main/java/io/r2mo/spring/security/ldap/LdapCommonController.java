...
import io.r2mo.spring.security.ldap.exception._80401Exception501Disabled;
...
public class LdapCommonController {
    ...
    public AuthTokenResponse login(final JObject params) {
        Fn.jvmKo(Objects.isNull(this.config), _80401Exception501Disabled.class);

        Fn.jvmKo(!this.config.isEnabled(), _80401Exception501Disabled.class);
