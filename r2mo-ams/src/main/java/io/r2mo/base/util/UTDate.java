...
final class UTDate {
    ...
    static boolean isDate(final Object value) {
        ...
        if (value instanceof final Class<?> valueClass) {

            return Date.class.isAssignableFrom(valueClass)      // < 1.8
                || Temporal.class.isAssignableFrom(valueClass); // > 1.8
        } else {
