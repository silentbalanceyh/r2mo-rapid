...
<${className}CommonResponse> createSingle(@Valid @RequestBody ${className}CommonRequest request);
    ...
    R
    <${className}CommonResponse> updateSingle(@PathVariable String id,
        ...
        R
        <Boolean> removeSingle(@PathVariable String id);
