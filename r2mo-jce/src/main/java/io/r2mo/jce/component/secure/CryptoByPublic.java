 ...
 */
public abstract class CryptoByPublic implements EDCrypto {

    protected CryptoByPublic() {
    }

    @Override
    public String encrypt(final String plainText) {
        // 私钥加密
        final String privateKey = this.data().getPublicKey();
    ...
    public String decrypt(final String cipherText) {
        // 公钥解密
        final String publicKey = this.data().getPrivateKey();
